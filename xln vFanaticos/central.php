...
$latest_price = $result_current['brl'];
...
?>
    ...
    <section id="central" class="section">
        <div class="container">
                    <div class="col-md-6 col-sm-6">
                        <h1>LUNARIUM: <br><span style="font-size:20px">CRIPTOMOEDA DESCENTRALIZADA</span></h1>
                        <em>"Calcule seu Investimento em XLN:"</em><br><br>
                        <div class="col-sm-4 text-center">
                            <label class="my-1 mr-2 text-center" for="inlineFormCustomSelectPref"><b>Valor em Reais:</b></label>
                            <input type="text" class="form-control text-center" name="valor_moeda" id="valor_moeda" value="" placeholder="Quantia em Reais" onkeyup="calc(this)">
                        </div>
                        <div class="col-sm-4 text-center">
                            <label class="my-1 mr-2 text-center" for="inlineFormCustomSelectPref"><b>Preço Atual:</b></label>
                        ...
                        <div class="col-sm-4 text-center">
                            <label class="my-1 mr-2 text-center" for="inlineFormCustomSelectPref"><b>Total em XLN:</b></label>
                            <input type="text" class="form-control text-center" name="valor_total_brl" id="valor_total_brl" value="0" readonly='readonly'/>
                        </div>
                    </div>
                    <div class="col-md-6 col-sm-6">
                        <h1>MASTERNODE: <br><span style="font-size:20px">VEJA O PREÇO E GANHO DE 1 MN XLN</span></h1>
                        ...
                        <div class="col-sm-3 text-center">
                            <label class="my-1 mr-2 text-center" for="inlineFormCustomSelectPref"><b>Real (BRL):</b></label>
                        ...
                        <h1 style="margin-bottom:10px; margin-top:75px"><span style="font-size:14px">"Calculo de Ganhos em XLN com 1 MN"</span></h1>
                        <div class="col-sm-4 text-center">
                            <label class="my-1 mr-2 text-center" for="inlineFormCustomSelectPref"><b>Mínimo Diario:</b></label>
                            ...
                            <label class="my-1 mr-2 text-center" for="inlineFormCustomSelectPref">R$ <?php echo number_format($reward_today_price, 2, '.', ','); ?></label>
                        </div>
                        <div class="col-sm-4 text-center">
                            <label class="my-1 mr-2 text-center" for="inlineFormCustomSelectPref"><b>Mínimo Mensal:</b></label>
                            ...
                            <label class="my-1 mr-2 text-center" for="inlineFormCustomSelectPref">R$ <?php echo number_format($reward_monthly_price, 2, '.', ','); ?></label>
                        </div>
                        <div class="col-sm-4 text-center">
                            <label class="my-1 mr-2 text-center" for="inlineFormCustomSelectPref"><b>Mínimo Anual:</b></label>
                            ...
                            <label class="my-1 mr-2 text-center" for="inlineFormCustomSelectPref">R$ <?php echo number_format($reward_yearly_price, 2, '.', ','); ?></label>
                        </div>
                        <h1><span style="font-size:20px">Masternodes Ativos: <?php echo number_format($masternode_count); ?></span></h1>
                    </div>
                </div>
        <!-- /container -->
    </section>
    ...
    <section id="central" class="section">
        ...
        <tr>
            ...
            <td>
                <?php if($value["lastseen"] == 0){ ?>DESCONHECIDO<?php } ?>
                <?php if($value["lastseen"] > 0){ ?><?php echo date("Y-m-d H:i:s", $value["lastseen"]);} ?>
            </td>
            <td>
                <?php if($value["lastpaid"] == 0){ ?>DESCONHECIDO<?php } ?>
