...
<body>
        ...
        <div class="tp-banner-container ">
            <div class="tp-banner rev-interactive">
                <div class="hero-caption caption-center caption-height-center container" style="z-index: 100;">
                    ...
                    <a class="btn btn-style-3 btn-lg mrg-top-30" href="/central_EN.php" target="_blank">Central MN</a>
                </div>
                <!-- /hero-caption -->
    ...
    <section id="about" class="section">
        <div class="container">
            <div class="col-sm-6">
                <h2 class="heading-left">About XLN</h2>
                <p class="sub-heading-left">What is XLN?</p>
                <p class="text-justify">We are a payment method that remunerates your holders through Stakes and Masternodes<br>
"Lunarium will seek friendly payment solutions for its entire ecosystem, with the scope of combining technological solutions with strategic partnerships to make Lunarium (XLN) a known and traded currency around the world"</p>
                <p class="text-justify">
                    Lunarium coin XLN came about after an exit scam by the former SOLARIUM coin team, we created a community-based coin aiming to continue the goals initially described by solarium coin.
                </p>
            </div>
            <!-- /column -->
            <div class="col-sm-6">
            ...
            <div class="image-container col-md-6">
                <div class="background-holder has-content parallax-overlay-dark" style="background-image: url(images/logo/gif-banner.gif)">
                    <div class="content text-center">
                        ...
                        <h2 class="mrg-top-30">Watch the video</h2>
                        <p class="droid-serif-italic font-size-15">Learn more about XLN</p>
                    </div>
                </div>
                <!-- /background-holder -->
            </div>
            ...
            <div class="features-1 mrg-top-25">
                <ul class="nav nav-tabs">
                    <li class="col-md-4 col-sm-8 col-xs-12 active features-menu">
                            ...
                            <h4 class="mrg-top-35">To develop</h4>
                            <p>technological solutions to facilitate the use of currency.</p>
                    </li>
                    <!-- /column -->

                    <li class="col-md-4 col-sm-8 col-xs-12 active features-menu ">
                            <i class="fa fa-check-square-o" aria-hidden="true"></i>
                            <h4 class="mrg-top-35">Expand</h4>
                            <p>the Lunarium community around the world through strategic partnerships.</p>
                    </li>
                    <!-- /column -->

                    <li class="col-md-4 col-sm-8 col-xs-12 active features-menu">
                            <i class="fa fa-check-square-o" aria-hidden="true"></i>
                            <h4 class="mrg-top-35">Insert</h4>
                            <p>Lunarium currency in payment methods in retail, industry, tourism, gaming industry, etc.</p>
                    </li>
                </ul>
            </div>
            <!-- Obj -->
    ...
    <section id="wallets">
        <div class="section-3 bg-grey">
            <h2 class="heading">Wallets, Softwares e Applications</h2>
            <p class="sub-heading">Lunarium is present in several systems.</p>
        </div>
    ...
    <section id="listagens" class="section">
        <div class="container mrg-top-50">
            ...
            <p class="sub-heading">Platforms, Pools, Exchanges & Apps</p>
        ...
        <div class="col-md-9">
            <div class="portfolio-filter-group text-center folio-fillter-2 mrg-top-50 mrg-btm-30">
                ...
                <a href="#" data-filter=".apps" class="iso-button">Applications</a>
                <a href="#" data-filter=".outros" class="iso-button">Others</a>
            </div>
            <!-- portfolio-filter -->
                            ...
                            <div class="overlay-caption">
                                <div class="overlay-content">
                                    ...
                                    <div class="folio-links">
                                        <a href="https://crex24.com/pt/exchange/XLN-BTC" target="_blank">Access</a>
                                    </div>
                                    <!-- folio-links -->
                                </div>
                                <!-- /overlay-content -->
                        ...
                        <div class="overlay">
                            <div class="overlay-caption">
                                <div class="overlay-content">
                                    ...
                                    <!-- /folio-info -->
                                    <div class="folio-links">
                                        <a href="https://bololex.com/trading/?symbol=XLN-DOGE" target="_blank">Access</a>
                                    </div>
                                    <!-- folio-links -->
                                </div>
                                <!-- /overlay-content -->
                            ...
                            <div class="overlay-caption">
                                <div class="overlay-content">
                                    <div class="folio-info">
                                        ...
                                        <p>Bets and Investments</p>
                                    </div>
                                    <!-- /folio-info -->
                                    <div class="folio-links">
                                        <a href="https://betting.fanaticoscriptos.com" target="_blank">Access</a>
                                    </div>
                                    <!-- folio-links -->
                                </div>
                                <!-- /overlay-content -->
                        ...
                        <div class="overlay">
                            <div class="overlay-caption">
                                <div class="overlay-content">
                                    ...
                                    <!-- /folio-info -->
                                    <div class="folio-links">
                                        <a href="https://t.me/Odacir" target="_blank">Access</a>
                                    </div>
                                    <!-- folio-links -->
                                </div>
                                <!-- /overlay-content -->
                        ...
                        <div class="overlay">
                            <div class="overlay-caption">
                                <div class="overlay-content">
                                    ...
                                    <!-- /folio-info -->
                                    <div class="folio-links">
                                        <a href="https://masternodes.biz/cryptocurrency/XLN" target="_blank">Access</a>
                                    </div>
                                    <!-- folio-links -->
                                </div>
                                <!-- /overlay-content -->
                        ...
                        <div class="overlay">
                            <div class="overlay-caption">
                                <div class="overlay-content">
                                    ...
                                    <!-- /folio-info -->
                                    <div class="folio-links">
                                        <a href="https://www.coinstake.in" target="_blank">Access</a>
                                    </div>
                                    <!-- folio-links -->
                                </div>
                                <!-- /overlay-content -->
                        ...
                        <div class="overlay">
                            <div class="overlay-caption">
                                <div class="overlay-content">
                                    ...
                                    <!-- /folio-info -->
                                    <div class="folio-links">
                                        <a href="https://t.me/Xlnpool_bot" target="_blank">Access</a>
                                    </div>
                                    <!-- folio-links -->
                                </div>
                                <!-- /overlay-content -->
                        ...
                        <div class="overlay">
                            <div class="overlay-caption">
                                <div class="overlay-content">
                                    ...
                                    <!-- /folio-info -->
                                    <div class="folio-links">
                                        <a href="https://radio.fanaticoscriptos.com.br" target="_blank">Access</a>
                                    </div>
                                    <!-- folio-links -->
                                </div>
                                <!-- /overlay-content -->
    ...
    <section class="video-parallax no-border parallax-overlay-dark">
        ...
        <div class="container text-center mrg-top-120 mrg-btm-50">
            ...
            ?>
            <h1 class="mrg-top-30">Current Block: <?php echo number_format($data_bloc, 0, '.', ','); ?></h1>
            ...
            <div class="owl-single-all owl-pagi-1 owl-nav-1 owl-carousel owl-theme team-style-2 ">
                <div class="item">
                    ...
                    <div class="col-md-6 col-sm-12 member-info">
                        ...
                        <h2 class="">Q3 2021</h2>
                        <p class="">
                            Restructuring and new version of the wallets, with improvements in performance, connection and designer.
                        </p>
                        <h2 class="">2022</h2>
                        <p class="">
                            In Development Structuring.
                        </p>
                    </div>
                    <!-- column -->
                </div>
    ...
    <section id="team" class="section-2 parallax parallax-overlay-dark" style="background-image:url(images/background/img-parallax-8.jpg)">
        <div class="container">
            <div class="row">
                <h2 class="heading mrg-btm-30">Who we are?</h2>
                <div class="col-md-3">
    ...
    <section id="contact">
        <div class="container-fluid no-padding-horizon">
            <div class="col-md-6 section-2" style="height: 735px">
                ...
                <p>Send us your criticisms and feedbacks.<br>or write to: marketing@xlunurium.org</p>
